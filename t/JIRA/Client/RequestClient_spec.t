...
BEGIN {
    use_ok('JIRA::Client::RequestClient');
}
...
#
#   
    it "assigns the client and attrs" => sub {
#    expect(subject.client).to eq(client)
#    expect(subject.attrs).to eq(attrs)
    };


    it "returns all the deadbeefs" => sub {
#    response = double()
...
#    expect(deadbeef.expanded?).to be_truthy
    ...
    it "finds a deadbeef containing changelog by id" => sub { 
...
#
    it "sets up an accessor for the belongs to relationship" => sub {
